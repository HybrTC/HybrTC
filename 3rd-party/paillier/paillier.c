...
void init_rand(gmp_randstate_t rand, paillier_get_rand_t get_rand, size_t bytes)
{
    void* buf;
    mpz_t s;
...
paillier_ciphertext_t* paillier_enc(
...
paillier_plaintext_t* paillier_dec(
...
paillier_plaintext_t* paillier_plaintext_from_bytes(void* m, size_t len)
{
    paillier_plaintext_t* pt;
...
void* paillier_plaintext_to_bytes(size_t len, paillier_plaintext_t* pt)
{
    void* buf0;
    void* buf1;
    size_t written;
